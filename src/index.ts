...
export function toggleLootDisplay(id: string) {
	...
	if (opentabs[0]) {
		Array.from(document.getElementsByClassName('artifacts') as HTMLCollectionOf<HTMLElement>)[0].style.minHeight = minH + "%";
	}
	else {
	...
	if (opentabs[1]) {
		Array.from(document.getElementsByClassName('materials') as HTMLCollectionOf<HTMLElement>)[0].style.minHeight = minH + "%";
	}
	else {
	...
	if (opentabs[2]) {
		Array.from(document.getElementsByClassName('miscellaneous') as HTMLCollectionOf<HTMLElement>)[0].style.minHeight = minH + "%";
	}
	else {
